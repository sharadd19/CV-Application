...
function App() {
  ...
  return (
    <>
    <div className="mainTitle"><h1>Build your CV</h1></div>
    <div className="wrapper">
      
      <div className="mainContainer">
        
        <button className="download" onClick={downloadCv}>Download</button>
        
        <div className="personalInformationInput">
          <div>
            <button className="toggle" onClick={togglePersonalInformation}>
              <h2>Personal Details{<span>{showPersonalInformation ? "▲" : "▼"}</span>}</h2>
            </button>
          </div>
