      ...
      <div className="card">
        {workExperiences.map((workExperience, index) => (
          <div key={workExperience.id} className="workExperienceCard">
            <div className="workExperienceTitle">
              <h3 className="workExperience"> Work Experience {index + 1}</h3>
            </div>

            <div className="position">
              <label htmlFor={workExperience.position}>
            ...
            <div className="company">
              <label htmlFor={workExperience.company}>
            ...
            <div className="city">
              <label htmlFor={workExperience.city}>
                {<strong>City</strong>}
              </label>
              <input
                type="text"
            ...
            <div className="startDate">
              <label htmlFor={workExperience.startDate}>
            ...
            <div className="endDate">
              <label htmlFor={workExperience.endDate}>
            ...
            <div className="description">
              <label htmlFor={workExperience.description}>
